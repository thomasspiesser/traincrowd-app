...
EasySearch.createSearchIndex('courses', {
  ...
  'query' : function (searchString, opts) {
    ...
    if (this.props.filteredCategory.toLowerCase() !== 'alle') {
...
Meteor.methods({
  ...
  addParticipant: function (currentId) {
    ...
    Meteor.call('sendBookingConfirmationEmail', { currentId: currentId, userId: this.userId } );
  },
  ...
  updateCategories: function (categories) {
    ...
    // var docs = Categories.find().count();
    // if (docs) {
    //   Categories.update({}, { $addToSet: {categories: categories} });
    // }
    // else {
    //   Categories.insert({
