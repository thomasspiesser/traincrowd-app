...
Meteor.methods({
  ...
  confirmCourseDate: function (courseId, instanceId, confirmedDate) {
    ...
    var inquirer = Courses.findOne( {_id: courseId}, { _id: 0, 'inquired.inquirer': 1} );
    Courses.update(
      courseId, 
      { $push: {current:
        { instanceId: instanceId, 
        participants: [inquirer], 
    ...
    Courses.update( 
      { _id: courseId, 'inquired.instanceId' : instanceId },
      { $pull: { inquired : { instanceId: instanceId } } }
    );
  },
