...
Router.route('/course/:slug/decline-event/:_token', {
  ...
  onBeforeAction: function(pause){
    Meteor.call('declineCurrent', this.params._token, function (error, result) {
      if (error)
...
Router.route('/berlins-top-trainer', {
  ...
  data: function () { 
    return { trainer: Meteor.users.find(  ) };
    // return { trainer: Meteor.users.find( {roles: 'trainer'} ) };
  }
});
