...
Router.route('/', {
  ...
  name: 'home',
  waitOn: function() {
    return [ sm.subscribe('topCourses'), sm.subscribe('topTrainer') ];
  },
  data: function () {
    return { 
      topCourses: Courses.find( {}, { limit: 6 } ),
      topTrainers: Meteor.users.find( {}, { limit: 4 } )
    };
  }
});
...
Router.route('/kurs-buchen/:_id/gebucht', {
