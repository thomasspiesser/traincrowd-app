...
allowedUserFields = ['title', 'name', 'email', 'description', 'mobile', 'phone', 'videoId', 'videoURL', 'homepage', 'certificates', 'employer', 'position', 'industry', 'workExperience', 'imageId', 'languages', 'firm', 'street', 'streetAdditional', 'streetNumber', 'plz', 'city'];